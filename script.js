...
let books = [
    ...
    new book(2, 'Geology of the Forest', 'Best Biology Author', 300, false, `https://source.unsplash.com/random/${bookCounter}`),
    new book(3, 'How to smoke Weed', 'Nate Diaz', 2000, false, `https://source.unsplash.com/random/${bookCounter}`),
    new book(4, 'Tobacco = Money', 'Dogfather Hermannson', 10210, true, `https://source.unsplash.com/random/${bookCounter}`),
];
